; Inno Setup Script for FilaHub (x64)
...
OutputBaseFilename=FilaHubSetup_x64
Compression=lzma
...
#ifdef WithNodeInstaller
Filename: "{tmp}\node-v24.11.1-x64.msi"; Parameters: "/quiet"; StatusMsg: "Installing Node.js (x64)..."; Flags: shellexec waituntilterminated; Check: ShouldInstallNode
#endif
